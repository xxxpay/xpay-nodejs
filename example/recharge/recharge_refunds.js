...
xpay.recharge.createRefund(APP_ID,
  '220170901352207144960002', // Recharge ID
  params_create,
  function (err, recharge) {
    if (err != null) {
      console.log('xpay.recharge.createRefund fail:', err);
    }
    // YOUR CODE
  });
 ...
 * 查询单个 recharge 退款
 */
xpay.recharge.retrieveRefund(APP_ID,
  '220170901352207144960002', // Recharge ID
  're_LSGuH4mjjj94Pm9GG4zHezX1', // Refund ID
  function (err, recharge) {
    if (err != null) {
      console.log('xpay.recharge.retrieveRefund fail:', err);
    }
    // YOUR CODE
  });
...
xpay.recharge.listRefunds(APP_ID,
  '220170822360378572800001', // Recharge ID
  params_list,
  function (err, recharges) {
    if (err != null) {
      console.log('xpay.recharge.listRefunds fail:', err);
    }
    // YOUR CODE
  });
