...
xpay.withdrawals.create(APP_ID, params, function (err, data) {
  if (err != null) {
    console.log('xpay.withdrawals.create fail:', err);
  }
  // YOUR CODE
});
...
xpay.withdrawals.list(
  ...
  function (err, data) {
    if (err != null) {
      console.log('xpay.withdrawals.retrieve fail:', err);
    }
    // YOUR CODE
  }
);
 ...
 * 账户提现撤销
 */
xpay.withdrawals.cancel(
  APP_ID, // App ID
  '1701709011053327225', // 提现 ID
  function (err, data) {
    if (err != null) {
      console.log('xpay.withdrawals.cancel fail:', err);
    }
    // YOUR CODE
  }
);
 ...
 * 账户提现确认
 */
xpay.withdrawals.confirm(
  APP_ID, // App ID
  '1701709011052380697', // 提现 ID
  function (err, data) {
    if (err != null) {
      console.log('xpay.withdrawals.confirm fail:', err);
    }
    // YOUR CODE
  }
);
