...
xpay.balanceTransactions.list(
  ...
  function (err, data) {
    if (err != null) {
      console.log('xpay.balanceTransactions.list fail:', err);
    }
    // YOUR CODE
  }
);
 ...
 * 查询账户余额明细对象
 */
xpay.balanceTransactions.retrieve(
  APP_ID,
  '310317061416154308155101', // Transaction ID
  function (err, data) {
    if (err != null) {
      console.log('xpay.balanceTransactions.retrieve fail:', err);
    }
    // YOUR CODE
  }
);
