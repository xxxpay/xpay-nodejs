...
// 接入红包流程参考开发者中心：https://pay.lucfish.com/docs/server/red-envelope ，文档可筛选后端语言和接入渠道。
...
/* list redEnvelopes */
xpay.redEnvelopes.list({
    limit: 10
  },
  function (err, redEnvelopes) {
    if (err != null) {
      console.log("xpay.redEnvelopes.list fail:", err);
    }
    // YOUR CODE
  }
);
