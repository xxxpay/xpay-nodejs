 ...
 * 创建分润结算对象
 */
xpay.royaltySettlements.create({
 ...
 * 查询分润结算对象
 */
xpay.royaltySettlements.retrieve(
 ...
 * 取消分润结算对象
 */
xpay.royaltySettlements.cancel(
  '431170401120500001', // royaltySettlements ID
  function (err, data) {
    // YOUR CODE
    if (err != null) {
 ...
 * 更新分润结算对象
 */
xpay.royaltySettlements.update(
  '431170401120500001', // royaltySettlements ID
  {
    'status': 'canceled'
