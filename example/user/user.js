...
xpay.users.create(APP_ID, {
  ...
  // YOUR CODE
  if (err != null) {
    console.log('xpay.users.create fail:', err);
  }
});
...
xpay.users.retrieve(
  ...
  function (err, user) {
    if (err != null) {
      console.log('xpay.users.retrieve fail:', err);
    }
    // YOUR CODE
  }
);
...
xpay.users.list(
  ...
  function (err, users) {
    if (err != null) {
      console.log('xpay.users.list fail:', err);
    }
    // YOUR CODE
  }
);
...
xpay.users.update(
  ...
  function (err, user) {
    if (err != null) {
      console.log('xpay.users.update fail:', err);
    }
    // YOUR CODE
  }
);
