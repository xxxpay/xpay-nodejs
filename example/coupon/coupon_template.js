...
xpay.couponTemplates.create(
  ...
  function (err, data) {
    if (err != null) {
      console.log("xpay.couponTemplates.create fail:", err)
    }
    // YOUR CODE
  }
);
 ...
 * 查询优惠券模板
 */
xpay.couponTemplates.retrieve(
  APP_ID, // APP ID
  "300117083118440300048601", // 优惠券模板 ID
  function (err, data) {
    if (err != null) {
      console.log("xpay.couponTemplates.retrieve fail:", err)
    }
    // YOUR CODE
  }
);
...
xpay.couponTemplates.list(
  ...
  function (err, datas) {
    if (err != null) {
      console.log("xpay.couponTemplates.list fail:", err)
    }
    // YOUR CODE
  }
);
...
xpay.couponTemplates.update(
  ...
  function (err, data) {
    if (err != null) {
      console.log("xpay.couponTemplates.update fail:", err)
    }
    // YOUR CODE
  }
);
 ...
 * 优惠券模板删除
 */
xpay.couponTemplates.delete(
  APP_ID, // APP ID
  "300117083118440300048601", // 优惠券模板 ID
  function (err, data) {
    if (err != null) {
      console.log("xpay.couponTemplates.delete fail:", err)
    }
    // YOUR CODE
  }
);
